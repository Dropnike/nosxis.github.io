...
<?php
    ...
    if(isset($_POST['btnSave'])){
        ...
        $insert_data = mysqli_query($conn, "INSERT INTO programtbl (programCode,programName,programDesc)
            VALUES ('$code','$name','$desc')");

        if($insert_data){
            header('Location:program.php?message=successadd');
        }
        else{
...
<?php
    ...
    if(isset($_POST['btnUpdate'])){
        ...
        mysqli_query($conn, "UPDATE programtbl SET programCode='$code', programName='$name', programDesc='$desc'
            WHERE programID=$id");

        header('location: program.php?message=successupdate');
    }
?>
...
<?php
    ...
    if(isset($_GET['delete'])){
        ...
        mysqli_query($conn, "DELETE FROM programtbl WHERE programID=$id");
        header('location: program.php?message=successdelete');
    }
?>
                ...
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu" aria-labelledby="navbarDropdown" >
                            <li><a class="dropdown-item active" href="program.php">Program</a></li>
                ...
                <div class="alert alert-success text-center" role="alert" id="alert">
                    <?php 
                        ...
                        elseif($_GET['message'] == "successupdate"){
                            echo "Successfully Updated Program";
                        }
                    ...
                    <table class="table table-borderless table-hover table-fixed">
                        <thead>
                            <tr style="width:100%">
                                ...
                                <th style="width:36%">Program Name</th>
                        ...
                        <tbody style="text-align:center;" class="table-primary">
                            <tr style="width:100%">
                                <td style="font-size:0px;" class="id"><?php echo $program['programID']?></td>
                                <td class="pcode"><?php echo $program['programCode']?></td>
                                <td class="pname"><?php echo $program['programName']?></td>
                                <td class="pdesc"><?php echo $program['programDesc']?></td>
                                <td>
                                    <a href="#editModal" class="edit" id="btnEditModal" name="btnEditModal" data-toggle="modal" style="text-decoration:none;">
                                        <i class="far fa-edit"></i>
                                    </a>
                                    <a href="program.php?delete=<?php echo $program['programID']?>" class="delete" name="btnDelete">
                    ...
                    <form method="POST" action="#">
                        ...
                        <div class="modal-body">
                            <div class="form-group">
                                ...
                                <input type="text" name="progcode" class="form-control" required>
                            </div>
                            <div class="form-group">
                                <label>Program Name</label>
                                <input type="text" name="progname" class="form-control" required>
                            </div>
                            <div class="form-group">
                                <label>Program Descriptions</label>
                                <textarea name="progdesc" class="form-control" required></textarea>
                            </div>
                        </div>
                    ...
                    <form method="POST" action="#">
                        ...
                        <div class="modal-body">
                            <div class="form-group">
                                ...
                                <input type="text" id="pcode" name="progcode" class="form-control" required>
                            </div>
                            <div class="form-group">
                                <label>Program Name</label>
                                <input type="text" id="pname" name="progname" class="form-control" required>
                            </div>
                            <div class="form-group">
                                <label>Program Description</label>
                                <textarea id="pdesc" name="progdesc" class="form-control" required></textarea>
                            </div>
                        </div>
                        <div class="modal-footer">
                            <button type="submit" class="btn btn-default" data-dismiss="modal">Cancel</button>
      ...
      if (txtValue.toUpperCase().indexOf(filter) > -1) {
        ...
        <script type="text/javascript">
            $('.edit').click(function(){
                ...
                var student_id = $row.find('.pcode').text();
                var name = $row.find('.pname').text();
                var address = $row.find('.pdesc').text();

                $('#id').val(id_num);
                $('#pcode').val(student_id);
                $('#pname').val(name);
                $('#pdesc').val(address);
