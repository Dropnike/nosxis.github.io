...
<?php
    ...
    if(isset($_POST['btnSave'])){
        ...
        $insert_data = mysqli_query($conn, "INSERT INTO progcurasstbl (programCurriculumCode,curriculumyrCode,programCode)
            VALUES ('$code','$name','$desc')");

        if($insert_data){
            header('Location:progcurassignment.php?message=successadd');
        }
        else{
...
<?php
    ...
    if(isset($_POST['btnUpdate'])){
        ...
        mysqli_query($conn, "UPDATE progcurasstbl SET programCurriculumCode='$code', curriculumyrCode='$name', programCode='$desc'
            WHERE programCurriculumID=$id");

        header('location: progcurassignment.php?message=successupdate');
    }
?>
...
<?php
    ...
    if(isset($_GET['delete'])){
        ...
        mysqli_query($conn, "DELETE FROM progcurasstbl WHERE programCurriculumID=$id");
        header('location: progcurassignment.php?message=successdelete');
    }
?>
                ...
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu" aria-labelledby="navbarDropdown" >
                            ...
                            <li><a class="dropdown-item active" href="progcurassignment.php">Program Curriculum Assignment</a></li>
        ...
        <div class="container-fluid">
            <div class="table-wrapper">
                <div class="table-title">
                    <div class="col-sm-6">
                        <h2><b>Assigned Program-Curriculum<b><h2>
                    </div>
                </div>
                    ...
                    <table class="table table-borderless table-hover table-fixed">
                        <thead>
                            <tr style="width:100%">
                                ...
                                <th style="width:20%">Program Curriculum Code</th>
                                <th style="width:36%">Curriculum Year Code</th>
                                <th style="width:40%">Program Code</th>
                        ...
                        <tbody style="text-align:center;" class="table-primary">
                            <tr style="width:100%">
                                <td class="id"><?php echo $curyr['programCurriculumID']?></td>
                                <td class="ccode"><?php echo $curyr['programCurriculumCode']?></td>
                                <td class="cname"><?php echo $curyr['curriculumyrCode']?></td>
                                <td class="cdesc"><?php echo $curyr['programCode']?></td>
                                <td>
                                    <a href="#editModal" class="edit" id="btnEditModal" name="btnEditModal" data-toggle="modal" style="text-decoration:none;">
                                        <i class="far fa-edit"></i>
                                    </a>
                                    <a href="progcurassignment.php?delete=<?php echo $curyr['programCurriculumID']?>" class="delete" name="btnDelete">
                ...
                <div class="modal-content">
                    <form method="POST" action="#">
                        <div class="modal-header">
                            <h4 class="modal-title">Assign Program Curriculum</h4>
                        ...
                        <div class="modal-body">
                            ...
                            <div class="form-group">
                                ...
                                <select name="curriculumname" class="form-control" required>
                                <?php
                            $select_data = mysqli_query($conn, "SELECT * FROM curriculumyrtbl");
                            while($Subject = mysqli_fetch_array($select_data)){
                        ?>
                                
                                <option value="<?php echo $Subject['curriculumyrCode']?>"><?php echo $Subject['curriculumyrCode']?></option>
                                <?php }; ?>
                                </select>
                            </div>
                            <div class="form-group">
                                <label>Program Code</label>
                                <select name="curriculumdesc" class="form-control" required>
                                <?php
                            $select_data = mysqli_query($conn, "SELECT * FROM programtbl");
                            while($Subject = mysqli_fetch_array($select_data)){
                        ?>
                                
                                <option value="<?php echo $Subject['programCode']?>"><?php echo $Subject['programCode']?></option>
                                <?php }; ?>
                                </select>
                            </div>
                        </div>
        ...
        <div id="editModal" class="modal fade">
            <div class="modal-dialog">
                <div class="modal-content">
                    <form method="POST" action="#">
                        <div class="modal-header">
                            <h4 class="modal-title">Edit Program Curriculum</h4>
                            <button type="button" class="close" data-dismiss="modal" aria-hidden="true">Close</button>
                        </div>
                        <div class="modal-body">
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <select name="curriculumname" id="cname" class="form-control" required>
                                <?php
                            $select_data = mysqli_query($conn, "SELECT * FROM curriculumyrtbl");
                            while($Subject = mysqli_fetch_array($select_data)){
                        ?>
                            ...
                            <div class="form-group">
                                ...
                                <select name="curriculumdesc" id="cdesc" class="form-control" required>
                                <?php
                            $select_data = mysqli_query($conn, "SELECT * FROM programtbl");
                            while($Subject = mysqli_fetch_array($select_data)){
                        ?>
