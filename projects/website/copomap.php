...
<?php
    ...
    if(isset($_POST['btnSave'])){
        ...
        $insert_data = mysqli_query($conn, "INSERT INTO co_po_map (courseOutcomeCode,programOutcomeCode,lvl)
            VALUES ('$checkcode','$scode','$pcode')");

        if($insert_data){
            header('Location:copomap.php?message=successadd');
        }
        else{
...
<?php
    ...
    if(isset($_POST['btnUpdate'])){
        ...
        mysqli_query($conn, "UPDATE co_po_map SET courseOutcomeCode='$checkcode', programOutcomeCode='$scode', lvl='$pcode'
            WHERE courseOutcomeID=$id");

        header('location: copomap.php?message=successupdate');
    }
?>
...
<?php
    ...
    if(isset($_GET['delete'])){
        ...
        mysqli_query($conn, "DELETE FROM co_po_map WHERE courseOutcomeID=$id");
        header('location: copomap.php?message=successdelete');
    }
?>
                ...
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu" aria-labelledby="navbarDropdown" >
                            ...
                            <li><a class="dropdown-item active" href="copomap.php">CO-PO Map</a></li>
        ...
        <div class="container-fluid">
            <div class="table-wrapper">
                <div class="table-title">
                    <div class="col-sm-6">
                        <h2><b>Course Outcomes & Program Outcomes<b><h2>
                    </div>
                </div>
                    ...
                    <table class="table table-borderless table-hover table-fixed">
                        <thead>
                            <tr style="width:100%">
                                ...
                                <th style="width:20%">Course Outcome Code</th>
                                <th style="width:36%">Program Outcome Code</th>
                                <th style="width:40%">Level</th>
                                <th style="width:4%">Actions</th>
                            </tr>
                        </thead>
                        <?php
                            $select_data = mysqli_query($conn, "SELECT * FROM co_po_map");
                            while($program = mysqli_fetch_array($select_data)){
                        ?>
                        <tbody style="text-align:center;" class="table-primary">
                            <tr style="width:100%">
                                <td style="font-size:0px;" class="id"><?php echo $program['courseOutcomeID']?></td>
                                <td class="clcode"><?php echo $program['courseOutcomeCode']?></td>
                                <td class="subcode"><?php echo $program['programOutcomeCode']?></td>
                                <td class="pccode"><?php echo $program['lvl']?></td>
                                <td>
                                    <a href="#editModal" class="edit" id="btnEditModal" name="btnEditModal" data-toggle="modal" style="text-decoration:none;">
                                        <i class="far fa-edit"></i>
                                    </a>
                                    <a href="copomap.php?delete=<?php echo $program['courseOutcomeID']?>" class="delete" name="btnDelete">
                ...
                <div class="modal-content">
                    <form method="POST" action="#">
                        <div class="modal-header">
                            <h4 class="modal-title">Add Course Outcome</h4>
                            <button type="button" class="close" data-dismiss="modal" aria-hidden="true">Close</button>
                        </div>
                        <div class="modal-body">
                            <div class="form-group">
                                <label>Course Outcome Code</label>
                                <select name="checkcode" class="form-control" required>
                                <?php
                    ...
                    <form method="POST" action="#">
                        ...
                        <div class="modal-body">
                            <div class="form-group">
                                ...
                                <select id="clcode" name="checkcode" class="form-control" required>
                                <?php
                            $select_data = mysqli_query($conn, "SELECT * FROM courseoutcometbl");
                            while($Subject = mysqli_fetch_array($select_data)){
                                ?>
