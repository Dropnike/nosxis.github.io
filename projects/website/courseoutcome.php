...
<?php
    ...
    if(isset($_POST['btnSave'])){
        ...
        $insert_data = mysqli_query($conn, "INSERT INTO courseoutcometbl (courseOutcomeCode,subjectCode,courseOutcomeDesc)
            VALUES ('$checkcode','$scode','$pcode')");

        if($insert_data){
            header('Location:courseoutcome.php?message=successadd');
        }
        else{
...
<?php
    ...
    if(isset($_POST['btnUpdate'])){
        ...
        mysqli_query($conn, "UPDATE courseoutcometbl SET courseOutcomeCode='$checkcode', subjectCode='$scode', courseOutcomeDesc='$pcode'
            WHERE syllabusID=$id");

        header('location: courseoutcome.php?message=successupdate');
    }
?>
...
<?php
    ...
    if(isset($_GET['delete'])){
        ...
        mysqli_query($conn, "DELETE FROM courseoutcometbl WHERE syllabusID=$id");
        header('location: courseoutcome.php?message=successdelete');
    }
?>
                ...
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu" aria-labelledby="navbarDropdown" >
                            ...
                            <li><a class="dropdown-item active" href="courseoutcome.php">Course Outcome</a></li>
                    ...
                    <table class="table table-borderless table-hover table-fixed">
                        <thead>
                            <tr style="width:100%">
                                ...
                                <th style="width:40%">Course Outcome Description</th>
